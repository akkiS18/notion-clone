...
export const getDocuments = query({
    ...
    handler: async (ctx, args) => {
        ...
        .withIndex(
            'by_user_parent',
            (q) => q.eq('userId', userId).eq('parenDocument', args.parentDocument)
        )
...
export const archive = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const archivedChildren = async (documentId: Id<'documents'>) => {
            ...
            .query('documents')
            .withIndex('by_user_parent', (q) => q.eq('userId', userId).eq("parenDocument", documentId))
            .collect()
...
export const restore = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if(existingDocument.parenDocument) {
            options.parenDocument = undefined
        }
