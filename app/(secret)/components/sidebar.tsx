...
export const Sidebar = () => {
  ...
  return (
    <>
        ...
        >
            <div className={cn(
                'h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-300 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition',
            ...
            <div className='absolute right-0 top-0 w-1 h-full cursor-ew-resize bg-primary/10 opacity-0
                    ...
                    <>
                        <div className='flex justify-between items-center'>
                            <div className="flex items-center gap-1 text-[13px]">
                                <Rocket />
                                <p className='opacity-70 fond-bold'>{plan} plan</p>
                            </div>
                            {plan === 'Free' ? (
                        ...
                        {plan === 'Free' && (
                        <Progress 
                            value={documents?.length && documents.length >= 3 ? 100 : (
                            documents?.length || 0
                            ) * 33.33}
                            className='mt-2 '
                        />
