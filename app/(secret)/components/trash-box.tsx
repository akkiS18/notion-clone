  ...
  return (
    <div className='text-sm'>
        <div className='flex items-center gap-x-2 p-2'>
            ...
            placeholder='Filter by page title...' value={search} onChange={(e) => setSearch(e.target.value)} />
        </div>
        ...
        <div className='mt-2 px-1 pb-1'>
            ...
            {filteredDocument.map((document) => (
              ...
              className='text-sm rounded-sm w-full hover:bg-primary/5 items-center text-primary justify-between' 
              role='button' onClick={() => router.push(`/documents/${document._id}`)}>
