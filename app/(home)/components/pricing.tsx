...
export const Pricing = () => {
  return (
    <div className='max-w-7xl mx-auto container'>
      <h1 className='text-2xl sm:text-3xl md:text-4xl font-bold max-2-2xl'>
      ...
      <div className="flex gap-4 flex-row flex-wrap mt-4">
        {teams.map((team, idx) => (
          <Image src={team} key={idx} width={50} height={50} alt='teams' />
        ))}
      </div>
...
const cards = [
  {
    title: 'Free',
    subtitle: 'For orginizing every corner of your work & life.',
    options: 
